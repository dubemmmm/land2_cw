...
export default async function LocationDetailPage({ params }) {
  ...
  const [market, admin, resources, neighborhoods] = await Promise.all([
  ...
  return (
    <AppShell active="map">
      <LocationDetailClient neighborhood={neighborhood} neighborhoods={neighborhoods} market={market} resources={resources} isAdmin={Boolean(admin)} />
    </AppShell>
  );
}
